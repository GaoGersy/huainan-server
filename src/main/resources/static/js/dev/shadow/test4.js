 				...
 				init:function(){
 					...
 					t.index = new Vue({
	                    ...
	                    methods: {	
						    ...
						    getDetail:function(){
						    	var vm = this;
							    var url=g.baseUrlfjh+"getImageByDataId?dataId="+vm.dataId+"&satelliteType="+vm.satelliteType;
							    vm.$http.get(url).then(function(res){
									if(res.data.code==200){
									 	...
									 	vm.time = g.dateFormat(vm.imgDetail.receiveTime,"yyyy-MM-dd");
